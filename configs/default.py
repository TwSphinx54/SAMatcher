...
_CN.TRAINER.FT_LR_SCALE = 0.1  # Fine-tuning learning rate scale

# step-based warm-up
_CN.TRAINER.WARMUP_TYPE = 'linear'  # [linear, constant]
_CN.TRAINER.WARMUP_RATIO = 0.1
_CN.TRAINER.WARMUP_STEP = 1875  # Original step-based warmup, will be overridden if WARMUP_EPOCHS is used
_CN.TRAINER.WARMUP_EPOCHS = 0  # Number of epochs for warmup. If > 0, overrides WARMUP_STEP.

# learning rate scheduler
_CN.TRAINER.SCHEDULER = 'MultiStepLR'  # [MultiStepLR, CosineAnnealing, ExponentialLR]
_CN.TRAINER.SCHEDULER_INTERVAL = 'epoch'  # [epoch, step]
_CN.TRAINER.MSLR_MILESTONES = [6, 9, 12, 14, 16, 18]  # MSLR: MultiStepLR
_CN.TRAINER.MSLR_GAMMA = 0.1
_CN.TRAINER.COSA_TMAX = 30  # COSA: CosineAnnealing
_CN.TRAINER.COSA_ETA_MIN = 0.  # COSA: CosineAnnealing minimum learning rate
...
_CN.TRAINER.LOG_EVERY_N_STEPS = 50  # Default value for scalar logging frequency
_CN.TRAINER.VIS_INTERVAL = 500     # Default value for visualization frequency
