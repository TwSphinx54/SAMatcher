...
from src.utils.dataloader import get_im_gt_name_dict, create_dataloaders, RandomHFlip, Resize, LargeScaleJitter
from src.utils.loss_mask import loss_masks
import src.utils.misc as misc
from src.utils.utils import show_anns
from src.build_samatcher import Trainer, build_samatcher
...
def get_args_parser():
    ...
    parser.add_argument("--checkpoint", type=str, default="checkpoints/sam2.1_hq_hiera_large.pt", 
                        help="The path to the SAM checkpoint to use for mask generation.")
    parser.add_argument("--device", type=str, default="cuda", 
                        help="The device to run generation on.")
    parser.add_argument("--model_cfg", type=str, default="configs/sam2.1/sam2.1_hq_hiera_l.yaml", 
                        help="The device to run generation on.")
...
def train(args, net, optimizer, train_dataloaders, valid_dataloaders, lr_scheduler):
    ...
    for epoch in range(epoch_start,epoch_num): 
        ...
        for data in metric_logger.log_every(train_dataloaders,1000):
            ...
            net.set_image(batched_input)
            
            masks_hq, scores, logits = net.predict_batch(point_coords=input_point,
...
if __name__ == "__main__":
    ...
    model = Trainer(build_samatcher(args.model_cfg, args.checkpoint))

    main(model, train_datasets, valid_datasets, args)
